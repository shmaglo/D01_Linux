...
## 1. Установка ОС.
- ![Установка ОС. Проверка версии.](./Part1_OC.png)
- > Смотрим версию установленной ОС

## 2. Создание пользователя
- ![Создание пользователя](./Part2_newuser.png)
- > Создаем нового пользователя, добавиляем в adm
- ![Проверка наличия пользователя](./Part2_checkuser.png)
- > Проверяем внеслись ли изменения

## 3. Настройка сети ОС
- ![Задать название машины](./Part3_hostname.png)
- > Задаем название машины
- ![Устанавливаем временную зону](./Part3_localtime.png)
- > Устанавливаем временную зону
- ![Проверка временной зоны](./Part3_timedatectl.png)
- > Проверяем временную зону
- ![Вывести сетевые интерфейсы наа экран](./Part3_net_interface.png)
...
- ![Получение адреса от DHCP сервера](./Part3_dhclient.png)
...
- ![Вывести на экран routes](./Part3_ip_route.png)
- > Внешний ip 10.0.2.15
- > gateway    10.0.2.2
- ![Задать статичные заданные вручную настройки ip, gw, dns](./Part3_statip.png)
- > Задаем статичные настройки ip, gateway, dns
- ![Применяем настройки](./Part3_netplan_apply.png)
- > Применяем настройки после чего делаем reboot
- ![Проверяем настройки](./Part3_check_static.png)
- > Проверяем заданные вручную настройки
- ![Пингуем хосты](./Part3_check_ping.png)
- > Пингуем хосты

## 4. Обновление ОС
- ![Обновление ОС](./Part4_update.png)
- Проверка была ли обновлена система

## 5. Использование команды sudo
- ![Разрешить пользователю выполнять sudo](./Part5_sudouser.png)
...
- ![htop pid](./Part9_pid.png)
- > htop PID
- ![htop percent_cpu](./Part9_cpu.png)
- > htop PERCENT_CPU
- ![htop percent_mem](./Part9_mem.png)
- > htop PERCENT_MEM
- ![htop time](./Part9_time.png)
- > htop TIME
- ![htop filter](./Part9_sshd.png)
- > htop отфильтрофан для sshd
- ![htop syslog](./Part9_syslog.png)
- > С процессом syslog используя поиск
- ![htop bonus](./Part9_setup.png)
- > С добавленным выводом hostname, clock, и uptime

## 10. Использование утилиты fdisk
- ![fdisk](./Part10_disk.png)
...
- ![du](./Part12_du.png)
- > Запустил команду du
- ![du home](./Part12_home.png)
- > Размер папки /home
- ![du var](./Part12_var.png)
- > Размер папки /var
- ![du var log](./Part12_logs_var.png)
- > Размер папки /var/log
- ![du var log bonus](./Part12_logs.png)
- > Вывод размера всех элементов папки /var/log

## 13. Установка и использование утилиты ncdu
- ![ncdu home](./Part13_home.png)
- > Вывод размера папки /home
- ![ncdu var](./Part13_var.png)
- > Размер папки /var
- ![ncdu var log](./Part13_var_log.png)
- > Размер папки /var/log

## 14. Работа с системными журналами
- ![var log dmesg](./Part14_dmesg.png)
- > Открытый файл /var/log/dmesg
- ![var lof syslog](./Part14_syslog.png)
- > Открытый файл /var/log/syslog
- ![var log auth](./Part14_auth.png)
- > Открытый файл /var/log/auth.log
- ![auth](./Part14_login.png)
- > Пользователь stas залогинился в системе 6 сентября в 22:21:58 by Login
- ![restart sshd](./Part14_restart.png)
- > Перезапуск службы sshd

## 15. Использование планировщика заданий CRON
- ![cron](./Part15_uptime.png)
- > Успешно выполненные задачи
- ![tasks](./Part15_crontasks.png)
- > список текущих заданий
- ![remove](./Part15_remove.png)
